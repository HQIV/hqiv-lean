...
lemma colorLieChartBracket_0_1_entry00 :
    lieBracketMat₃ (colorHalfGellMannFull (0 : Fin 8)) (colorHalfGellMannFull (1 : Fin 8)) 0 0 =
    (I • ∑ c : Fin 8, (colorSu3fStructure (0 : Fin 8) (1 : Fin 8) c : ℂ) • colorHalfGellMannFull c) 0 0 := by
