...
slots.  Solar-system Doppler propagation can stay on the near-pole Kirchhoff
band (`solarSystemPropagationShell = 0`) while the source action of ordinary
baryonic matter is anchored at `flybyAnchorShell = referenceM = 4`.
